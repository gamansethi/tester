...
DATATYPE_LOCATIONS.append('mynewproject.datatypes')
FUNCTION_LOCATIONS.append('mynewproject.functions')
SEARCH_COMPONENT_LOCATIONS.append('mynewproject.search_components')
...
SECRET_KEY = 'cj!uuk11u+=ja_chxtkaw=u06-7o))_d2=^_)1k8^o-n-_d&l*'
...
ELASTICSEARCH_PREFIX = 'mynewproject'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'mynewproject.search_indexes.sample_index.SampleIndex',
...
SESSION_COOKIE_NAME = 'mynewproject'
